// Compiled with Require.js on Sat Aug 02 2014 16:51:02 GMT-0500 (CDT)
...
(function(index, modules, paths, Buffer, process, global) {
    ...
    function Process() {
        ...
        this.execPath = ".";
        this.execArgv = [];
        this.arch = (/\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(navigator.platform)[0] || "unknown").replace(/86_/i, "").toLowerCase();
